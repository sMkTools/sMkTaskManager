...
public class sMkPerfChart : UserControl {
    ...
    private decimal _MaxValue = 0M;          // The highest displayed value, required for Relative Scale Mode
    private decimal _MaxStrictValue = 0M;    // The highest displayed value, required for Strict Scale Mode
    private decimal _AverageValue1 = 0M;     // The average value for first index
    private decimal _AverageValue2 = 0M;     // The average value for second index
    ...
    private decimal _MaxLegendValue;
    ...
    private List<decimal> _Values = new(MAX_VALUE_COUNT);
    private List<decimal> _ValuesSecond = new(MAX_VALUE_COUNT);
    ...
    public decimal LastValue { get; private set; } = 0M;
    public decimal LastSecondValue { get; private set; } = 0M;
    public bool UseTwoValues { get; set; } = false;
    public decimal MaxValue {
        get { return _MaxStrictValue; }
        set { _MaxStrictValue = (value * 1.1M); }
    }
    ...
    private decimal CalcHighestValue() {
        _MaxValue = 0;
        for (int i = 0; i < _VisibleValues; i++) {
    ...
    private decimal CalcMaxLegendValue() {
