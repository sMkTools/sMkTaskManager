...
internal unsafe static partial class API {
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct PAGE_FILE_INFORMATION {
        public int Count;
        public int Reserved;
    ...
    public static partial NTSTATUS NtQuerySystemInformation(SYSTEM_INFORMATION_CLASS SystemInformationClass, ref SYSTEM_PERFORMANCE_INFORMATION SystemInformation, int SystemInformationLength, out int returnLength);
