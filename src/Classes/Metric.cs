...
internal interface IMetricListener {
    void AnyChanged(Metric sender, MetricChangedEventArgs e);
    void ValueChanged(Metric sender, MetricChangedEventArgs e);
    void DeltaChanged(Metric sender, MetricChangedEventArgs e);
}
